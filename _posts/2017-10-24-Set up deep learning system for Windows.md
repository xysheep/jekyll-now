...
- You might encouter a warning saying the cuda version is not compatible with your driver, just ignore it.
...
- Newest version of cuDNN can be downloaded from [here](https://developer.nvidia.com/cudnn), people need to register before downloading them. We can download the **cuDNN v7.0 Library for CUDA 8.0 for Windows 10**, this link will give you a file named "**cudnn-8.0-windows10-x64-v7.zip**". 
